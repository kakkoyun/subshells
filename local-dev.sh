...
function deploy() {
    ...
    kubectl apply -f https://github.com/parca-dev/parca/releases/download/v0.15.0/kubernetes-manifest.yaml
    kubectl apply -f https://github.com/parca-dev/parca-agent/releases/download/v0.12.0/kubernetes-manifest.yaml
